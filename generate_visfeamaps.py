...
ckpt_path = 'E:/Code running/model/model_vgg16_DANet'
exp_name = ''
...
to_test = {'test':'E:\Dataset\VT821\RGBT-Saliency-Dataset\RGBT-Saliency-Dataset'}
    ...
    with torch.no_grad():
        ...
        for name, root in to_test.items():
            ...
            for idx, img_name in enumerate(img_list):
                ...
                depth = Image.open(os.path.join(root,'T',img_name + '.jpg')).convert('L')
                w,h = img1.size
                ...
                output, attention1,attention2,attention3,attention4,attention5 = net(img_var,depth)
